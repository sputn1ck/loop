...
type LoopInSource int32

const (
	// Use the legacy wallet-funded loop-in flow.
	LoopInSource_LOOP_IN_SOURCE_WALLET LoopInSource = 0
	// Use deposited static-address funds for loop-in autoloops.
	LoopInSource_LOOP_IN_SOURCE_STATIC_ADDRESS LoopInSource = 1
)

// Enum value maps for LoopInSource.
var (
	LoopInSource_name = map[int32]string{
		0: "LOOP_IN_SOURCE_WALLET",
		1: "LOOP_IN_SOURCE_STATIC_ADDRESS",
	}
	LoopInSource_value = map[string]int32{
		"LOOP_IN_SOURCE_WALLET":         0,
		"LOOP_IN_SOURCE_STATIC_ADDRESS": 1,
	}
)

func (x LoopInSource) Enum() *LoopInSource {
	p := new(LoopInSource)
	*p = x
	return p
}

func (x LoopInSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LoopInSource) Descriptor() protoreflect.EnumDescriptor {
	return file_client_proto_enumTypes[4].Descriptor()
}

func (LoopInSource) Type() protoreflect.EnumType {
	return &file_client_proto_enumTypes[4]
}

func (x LoopInSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LoopInSource.Descriptor instead.
func (LoopInSource) EnumDescriptor() ([]byte, []int) {
...
type SweepHtlcRequest struct {
	...
	SatPerVbyte uint32 `protobuf:"varint,2,opt,name=sat_per_vbyte,json=satPerVbyte,proto3" json:"sat_per_vbyte,omitempty"`
	...
	// expected pkScript.
	HtlcAddress   string `protobuf:"bytes,6,opt,name=htlc_address,json=htlcAddress,proto3" json:"htlc_address,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SweepHtlcRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SweepHtlcRequest) GetSatPerVbyte() uint32 {
	if x != nil {
...
func (x *SweepHtlcRequest) GetOutpoint() string {
	if x != nil {
		return x.Outpoint
	}
	return ""
...
func (x *SweepHtlcRequest) GetPreimage() []byte {
	if x != nil {
		return x.Preimage
	}
	return nil
...
func (x *SweepHtlcRequest) GetPublish() bool {
	if x != nil {
		return x.Publish
	}
	return false
...
func (x *SweepHtlcRequest) GetHtlcAddress() string {
	if x != nil {
		return x.HtlcAddress
	}
	return ""
...
type SweepHtlcResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Raw sweep transaction bytes.
	SweepTx []byte `protobuf:"bytes,1,opt,name=sweep_tx,json=sweepTx,proto3" json:"sweep_tx,omitempty"`
	...
	// Publish outcome.
	//
	// Types that are valid to be assigned to Publish:
	//
	//	*SweepHtlcResponse_NotRequested
	//	*SweepHtlcResponse_Published
	//	*SweepHtlcResponse_Failed
	Publish       isSweepHtlcResponse_Publish `protobuf_oneof:"publish"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SweepHtlcResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SweepHtlcResponse) GetFeeSats() uint64 {
	if x != nil {
		return x.FeeSats
	}
	return 0
...
func (x *SweepHtlcResponse) GetPublish() isSweepHtlcResponse_Publish {
	if x != nil {
		return x.Publish
	}
	return nil
...
func (x *SweepHtlcResponse) GetNotRequested() *PublishNotRequested {
	if x != nil {
		if x, ok := x.Publish.(*SweepHtlcResponse_NotRequested); ok {
			return x.NotRequested
		}
	}
	return nil
}

func (x *SweepHtlcResponse) GetPublished() *PublishSucceeded {
	if x != nil {
		if x, ok := x.Publish.(*SweepHtlcResponse_Published); ok {
			return x.Published
		}
	}
	return nil
...
func (x *SweepHtlcResponse) GetFailed() *PublishFailed {
	if x != nil {
		if x, ok := x.Publish.(*SweepHtlcResponse_Failed); ok {
			return x.Failed
		}
	}
	return nil
...
type isSweepHtlcResponse_Publish interface {
	isSweepHtlcResponse_Publish()
}

type SweepHtlcResponse_NotRequested struct {
	NotRequested *PublishNotRequested `protobuf:"bytes,3,opt,name=not_requested,json=notRequested,proto3,oneof"`
}

type SweepHtlcResponse_Published struct {
	Published *PublishSucceeded `protobuf:"bytes,4,opt,name=published,proto3,oneof"`
}

type SweepHtlcResponse_Failed struct {
	Failed *PublishFailed `protobuf:"bytes,5,opt,name=failed,proto3,oneof"`
}

func (*SweepHtlcResponse_NotRequested) isSweepHtlcResponse_Publish() {}

func (*SweepHtlcResponse_Published) isSweepHtlcResponse_Publish() {}

func (*SweepHtlcResponse_Failed) isSweepHtlcResponse_Publish() {}

// PublishNotRequested is returned by SweepHtlc if publishing was not requested
// in SweepHtlcRequest.
type PublishNotRequested struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PublishNotRequested) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PublishSucceeded) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PublishFailed) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type QuoteRequest struct {
	...
	AutoSelectDeposits bool `protobuf:"varint,10,opt,name=auto_select_deposits,json=autoSelectDeposits,proto3" json:"auto_select_deposits,omitempty"`
...
func (x *QuoteRequest) GetAutoSelectDeposits() bool {
	if x != nil {
		return x.AutoSelectDeposits
	}
	return false
}

func (x *QuoteRequest) GetFast() bool {
	if x != nil {
		return x.Fast
	}
	return false
...
type InQuoteResponse struct {
	...
	// selected deposits.
	QuotedAmt     int64 `protobuf:"varint,7,opt,name=quoted_amt,json=quotedAmt,proto3" json:"quoted_amt,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InQuoteResponse) GetQuotedAmt() int64 {
	if x != nil {
		return x.QuotedAmt
	}
	return 0
...
type LiquidityParameters struct {
	...
	EasyAssetParams map[string]*EasyAssetAutoloopParams `protobuf:"bytes,25,rep,name=easy_asset_params,json=easyAssetParams,proto3" json:"easy_asset_params,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	LoopInSource  LoopInSource `protobuf:"varint,28,opt,name=loop_in_source,json=loopInSource,proto3,enum=looprpc.LoopInSource" json:"loop_in_source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LiquidityParameters) GetEasyAutoloopExcludedPeers() [][]byte {
	if x != nil {
...
func (x *LiquidityParameters) GetLoopInSource() LoopInSource {
	if x != nil {
		return x.LoopInSource
	}
...
type SuggestSwapsResponse struct {
	...
	StaticLoopIn []*StaticAddressLoopInRequest `protobuf:"bytes,4,rep,name=static_loop_in,json=staticLoopIn,proto3" json:"static_loop_in,omitempty"`
...
func (x *SuggestSwapsResponse) GetStaticLoopIn() []*StaticAddressLoopInRequest {
	if x != nil {
		return x.StaticLoopIn
	}
	return nil
}
...
type ListStaticAddressWithdrawalRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListStaticAddressWithdrawalRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ListStaticAddressWithdrawalResponse struct {
	...
	Withdrawals   []*StaticAddressWithdrawal `protobuf:"bytes,1,rep,name=withdrawals,proto3" json:"withdrawals,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListStaticAddressWithdrawalResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *Deposit) GetSwapHash() []byte {
	if x != nil {
		return x.SwapHash
	}
	return nil
...
func (x *StaticAddressWithdrawal) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *StaticAddressWithdrawal) GetDeposits() []*Deposit {
	if x != nil {
		return x.Deposits
	}
	return nil
...
func (x *StaticAddressWithdrawal) GetTotalDepositAmountSatoshis() int64 {
	if x != nil {
		return x.TotalDepositAmountSatoshis
	}
	return 0
}

func (x *StaticAddressWithdrawal) GetWithdrawnAmountSatoshis() int64 {
	if x != nil {
		return x.WithdrawnAmountSatoshis
	}
	return 0
}

func (x *StaticAddressWithdrawal) GetChangeAmountSatoshis() int64 {
	if x != nil {
		return x.ChangeAmountSatoshis
	}
	return 0
}

func (x *StaticAddressWithdrawal) GetConfirmationHeight() uint32 {
	if x != nil {
		return x.ConfirmationHeight
	}
	return 0
...
func (x *StaticAddressLoopInSwap) GetDeposits() []*Deposit {
	if x != nil {
		return x.Deposits
	}
	return nil
...
func (x *StaticAddressLoopInRequest) GetAmount() int64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *StaticAddressLoopInRequest) GetFast() bool {
	if x != nil {
		return x.Fast
	}
	return false
...
type StaticAddressLoopInResponse struct {
	...
	UsedDeposits []*Deposit `protobuf:"bytes,12,rep,name=used_deposits,json=usedDeposits,proto3" json:"used_deposits,omitempty"`
	// The amount that is being swapped (may be less than total deposit value if
	// change is returned).
	SwapAmount uint64 `protobuf:"varint,13,opt,name=swap_amount,json=swapAmount,proto3" json:"swap_amount,omitempty"`
	// The change amount that will be returned to the static address.
	Change int64 `protobuf:"varint,14,opt,name=change,proto3" json:"change,omitempty"`
	// If set, indicates that the server was requested to use fast publication
	// behavior.
	Fast          bool `protobuf:"varint,15,opt,name=fast,proto3" json:"fast,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StaticAddressLoopInResponse) GetUsedDeposits() []*Deposit {
	if x != nil {
		return x.UsedDeposits
	}
	return nil
}

func (x *StaticAddressLoopInResponse) GetSwapAmount() uint64 {
	if x != nil {
		return x.SwapAmount
	}
	return 0
...
func (x *StaticAddressLoopInResponse) GetChange() int64 {
	if x != nil {
		return x.Change
	}
	return 0
...
func (x *StaticAddressLoopInResponse) GetFast() bool {
	if x != nil {
		return x.Fast
	}
	return false
